 ...
 */
public class LibhpcAliasCustomElementDeserializer implements ExtensionDeserializer {
    ...
    public void deserialize(XmlSchemaObject schemaObject, QName name, Node domNode) {
        ...
        if (LibhpcAliasCustomElement.LIBHPC_ALIAS_CUSTOM_ELEMENT_QNAME.equals(name)) {
            Element elt = (Element) domNode;
            String value = elt.getNodeValue();
            LibhpcAliasCustomElement alias = new LibhpcAliasCustomElement();
